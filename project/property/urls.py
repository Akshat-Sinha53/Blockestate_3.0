...
urlpatterns = [
    ...
    path('surveyor/login/', surveyor_views.login_surveyor, name='login_surveyor'),
    path('surveyor/pending/', surveyor_views.list_pending_for_surveyor, name='list_pending_for_surveyor'),
]
